...
const Index = () => {
  ...
  const features = [
    {
      icon: <QrCode className="h-8 w-8 text-amber-600" />,
      ...
      <header className="container mx-auto px-4 py-6">
        <nav className="flex items-center justify-between">
          ...
          <Button 
            ...
            className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white px-6 py-2 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
          >
            Get Started
          </Button>
        </nav>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-amber-500 to-orange-500 bg-clip-text text-transparent"> Digital Ordering</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button 
              onClick={() => navigate('/auth')}
              size="lg"
              className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white px-8 py-4 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl text-lg"
            >
              Start Free Trial
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-amber-500 text-amber-600 hover:bg-amber-50 px-8 py-4 rounded-lg font-medium transition-all duration-200 text-lg"
            >
              Watch Demo
            </Button>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button 
                onClick={() => navigate('/auth')}
                size="lg"
                className="mt-8 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white px-8 py-4 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                Get Started Today
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            ...
            <div className="lg:text-right">
              <div className="bg-gradient-to-br from-amber-100 to-orange-100 p-8 rounded-2xl border border-amber-200">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-2xl p-8 md:p-12 text-center text-white">
          ...
          <Button 
            ...
            size="lg"
            variant="secondary"
            className="bg-white text-amber-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl text-lg"
          >
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            ...
            <p className="mt-2">
              Powered by <a href="https://spslabs.vercel.app" target="_blank" rel="noopener noreferrer" className="text-amber-400 hover:text-amber-300 font-semibold transition-colors">SPS Labs</a>
            </p>
          </div>
        </div>
      </footer>
