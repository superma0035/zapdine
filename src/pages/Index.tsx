...
import { Star, Users, Clock, Shield, ArrowRight, CheckCircle } from "lucide-react";
...
const Index = () => {
  ...
  const features = [
    {
      icon: Clock,
      title: "Quick Setup",
      description: "Get your restaurant online in minutes with our easy setup process"
    },
    {
      icon: Users,
      title: "Customer Experience",
      description: "Provide seamless ordering experience with QR code scanning"
    },
    {
      icon: Shield,
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-gray-900">ZapDine</span>
            </div>
            <Button
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#FF5733] to-[#FF7F50] text-white">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                onClick={() => navigate('/auth')}
                size="lg"
                className="bg-white text-[#FF5733] hover:bg-gray-100 text-lg px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
              >
                Start Free Trial
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-2 border-white text-white hover:bg-white hover:text-[#FF5733] text-lg px-8 py-4 rounded-xl font-semibold bg-transparent backdrop-blur-sm"
              >
                Learn More
              </Button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-200">
                  <div className="w-12 h-12 bg-[#FF5733] rounded-lg flex items-center justify-center mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-[#FF5733] to-[#FF7F50] rounded-2xl p-8 text-white">
                <div className="text-center">
                  ...
                  <Button
                    onClick={() => navigate('/auth')}
                    className="bg-white text-[#FF5733] hover:bg-gray-100 w-full"
                  >
                    Get Started Today
                  </Button>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Create your profile, upload your menu, and generate QR codes for your tables in minutes.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Receive orders in real-time, track preparation, and deliver exceptional experiences.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-br from-[#FF5733] to-[#FF7F50] text-white">
